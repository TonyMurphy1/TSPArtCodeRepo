...
public class MainFrame extends JFrame {
	...
	public JPanel createButtonPanel() {
		...
		userHelpText.setAlignmentX(LEFT_ALIGNMENT);
		userHelpText.setText("Welcome to the TSP Art Generator! Load a image to begin. The user guide describes the compatible image file formats.");
	...
	public void loadImageClicked() {
		...
		solveAsTSPInstanceButton.setEnabled(false);
		viewTSPArtButton.setEnabled(false);
		setUserHelpText("Now that you've loaded an image you wish to convert to TSP Art, the next step is to convert that image into a greyscale version of itself!");
	}
	...
	public void greyscaleConversionClicked() {
		...
		solveAsTSPInstanceButton.setEnabled(false);
		viewTSPArtButton.setEnabled(false);
		setUserHelpText("Excellent! This program is now able to create a stippled version of this image.");
	}
	...
	public void stippleImageClicked() {
		...
		viewTSPArtButton.setEnabled(false);
		setUserHelpText("The final step in creating TSP art is to treat the points of this stippled image as an instance of the travelling salesman problem!");
	}
	...
	public void solveTSPInstanceClicked() {
		...
		setUserHelpText("Here it is! A TSP Art version of your input image. Experiment with the previous steps to see if it improves the final look of the picture!");
	}
